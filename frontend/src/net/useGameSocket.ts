...
export default function useGameSocket({
  ...
  const handlerCtx: HandlerCtx = {
    ...
    onShopOpen, onImpDialogue, onGhostDialogue, onWandmakerDialogue, onGhostQuestGiven, onGhostQuestComplete, onScrollSelectTarget, onGhostGearOpen, onBossSlain, onPlayerDeath,
